                        ...
                        <div style="height: 250px; margin-bottom:25px" class="col-md-2 gatocard">
                            <div style="height: 100%" class="card">
                                ...
                                <div style="height: 100px;" class="card-body">
                                    ...
                                    <a style="height:40px; margin-top:5px" href="" class="btn boton-animales"><svg xmlns="http://www.w3.org/2000/svg" width="19" height="19" fill="currentColor" class="bi bi-pencil-square" viewBox="0 0 16 16">
