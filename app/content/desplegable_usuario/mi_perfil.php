      ...
      <div class="col-md-4" style="height: 600px">
        <div class="card" style="height: 860px">
          ...
          <?php if (!isset($orden) || $orden != "Modificar") : ?>
            ...
            <?php endif; ?>
              <?php if (isset($orden) && $orden == "Modificar") : ?>
              <a href="./mi_perfil.php" class="btn boton-animales "> <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x-circle-fill" viewBox="0 0 16 16">
        ...
        <div class="card">
          ...
          <div class="card-body" >
            <div class="container">
              ...
              <div class="card-footer" ><a class="btn boton-animales" href="./gestion_animales.php"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" fill="currentColor" class="bi bi-database-fill-gear" viewBox="0 0 16 16">
